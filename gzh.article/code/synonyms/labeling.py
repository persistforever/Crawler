...
class StaticTextFrame(wx.Frame):  
    def __init__(self):  
        wx.Frame.__init__(self, None, -1, u'文章人工标注'.encode('gbk'), size=(1000, 350))  
        ...
        goodbutton = wx.Button(self.panel, label=u'知识性'.encode('gbk'), pos=(50, 150), size=(250, 50))
        goodbutton.Bind(wx.EVT_BUTTON, self.markGood, goodbutton)
        badbutton = wx.Button(self.panel, label=u'非知识性'.encode('gbk'), pos=(375, 150), size=(250, 50))
        badbutton.Bind(wx.EVT_BUTTON, self.markBad, badbutton)
        unknowbutton = wx.Button(self.panel, label=u'不知道'.encode('gbk'), pos=(700, 150), size=(250, 50))
        unknowbutton.Bind(wx.EVT_BUTTON, self.markUnknow, unknowbutton)
        upperbutton = wx.Button(self.panel, label=u'上一页'.encode('gbk'), pos=(50, 230), size=(250, 50))
        upperbutton.Bind(wx.EVT_BUTTON, self.frontPage, upperbutton)
        savebutton = wx.Button(self.panel, label=u'保存'.encode('gbk'), pos=(700, 230), size=(250, 50))
